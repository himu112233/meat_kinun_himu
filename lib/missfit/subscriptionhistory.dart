            ...
            child: AppBar(
              ...
              title: Center(
                child: Container(
                  width: 320,
                  height: 20,
                  padding: const EdgeInsets.only(left: 0.15, right: 76),
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Image.asset('assets/missfit/percent_logo.png'), // Replace with your asset image
                      ),
                      const SizedBox(width: 56.85),
                      Text(

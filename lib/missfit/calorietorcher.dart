...
class CalorieApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        backgroundColor: Colors.red[600], // Set the background color of the scaffold to red
        body: YourWidget(),
      ),
    );
  }
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: AssetImage("assets/missfit/banner_img.png"), // Replace "your_image.png" with your asset image path
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              Positioned(
                ...
                child: Container(
                  ...
                  child: Image.asset(
                    "assets/missfit/back_img.png", // Replace "your_image.png" with your asset image path
                    width: 20,
                    height: 20,
                  ),
                ),
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.only(
                  topRight: Radius.circular(35), // You can adjust the radius as needed
                  bottomLeft: Radius.circular(35), // You can adjust the radius as needed
                ),
              ),
              child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            'Overview',
                            style: TextStyle(
                              color: Colors.black, // Change color to white if needed
                              fontSize: 16,
                              fontFamily: 'Archivo',
                        ...
                        SizedBox(height: 20), // Add spacing between the "Overview" text and the new container
                        Padding(
                          padding: const EdgeInsets.only(left: 20.0),
                          child: Container(
                            width: 300,
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                         ...
                         SizedBox(height: 20), //// Add spacing between the "Exercises" text and the new container
